  ...
  <div>
    ...
    <CRow>
      ...
      <CCol xs="12" md="6">
        <CCard>
          <CCardHeader>
            Switchфывфвы <small><code>label variant="outline"</code></small>
          </CCardHeader>
          <CCardBody>
            <CSwitch
              class="mx-1"
      ...
      <CCol xs="12" md="6">
        <CCard>
          <CCardHeader>
            Switch еееееее<small><code>label variant="opposite"</code></small>
          </CCardHeader>
          <CCardBody>
            <CSwitch
              class="mx-1"
      ...
      <CCol xs="12" md="6">
        <CCard>
          <CCardHeader>
            Switch укукккккк<small><code>label variant="opposite"</code></small>
          </CCardHeader>
          <CCardBody>
            <CSwitch
              class="mx-1"
